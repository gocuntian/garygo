...
/*
Package go_grpc is a generated protocol buffer package.
...
func init() {
	proto.RegisterType((*Request)(nil), "go.grpc.Request")
	proto.RegisterType((*Response)(nil), "go.grpc.Response")
}
...
func (c *kittensClient) Hello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := grpc.Invoke(ctx, "/go.grpc.Kittens/Hello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Kittens_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.grpc.Kittens/Hello",
	}
...
var fileDescriptor0 = []byte{
	...
	0x49, 0xcd, 0x2b, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4f, 0xcf, 0xd7, 0x4b, 0x2f,
	...
	0xd3, 0xa1, 0xd2, 0x20, 0xa6, 0x91, 0x25, 0x17, 0xbb, 0x37, 0xc4, 0x58, 0x21, 0x3d, 0x2e, 0x56,
	0x8f, 0xd4, 0x9c, 0x9c, 0x7c, 0x21, 0x01, 0x3d, 0xa8, 0xd1, 0x7a, 0x50, 0x73, 0xa5, 0x04, 0x91,
	0x44, 0x20, 0x46, 0x29, 0x31, 0x24, 0xb1, 0x81, 0xdd, 0x61, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0x2a, 0x2f, 0x89, 0xb7, 0x98, 0x00, 0x00, 0x00,
}
